...
class IndexController extends Yaf_Controller_Abstract {
	...
	public function indexAction()
	{
		...
		#只渲染模板
		#$content = $this->getView()->render('Index');
		#die;

		$this->_view->assign('baseUri', $this->_request->getBaseUri());

		$this->getView()->display('Frame');
	}
	...
	public function echartsAction()
	{
		...
		//$this->_view->assign('baseUri', $this->_request->getBaseUri());
		$this->_view->baseUri = $this->_request->getBaseUri());
		$this->getView()->display('Chart');
	}
