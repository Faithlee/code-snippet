...
let g:pdv_cfg_Comment_not_space = "* "
...
let g:pdv_cfg_Version = "$_SWANBR_VERSION_$"
let g:pdv_cfg_Author = "$_SWANBR_AUTHOR_$"
let g:pdv_cfg_Copyright = "$_SWANBR_COPYRIGHT_$"
...
func! PhpDocClass()
    ...
    exe l:txtBOL . "/* vim: set expandtab tabstop=4 shiftwidth=4 softtabstop=4 foldmethod=marker: */". g:pdv_cfg_EOL
    exe l:txtBOL . l:txtHR_C . g:pdv_cfg_EOL
    exe l:txtBOL . "// | SWAN [ $_SWANBR_SLOGAN_$ ]" . g:pdv_cfg_EOL
    exe l:txtBOL . l:txtHR_C . g:pdv_cfg_EOL
    exe l:txtBOL . "// | Copyright $_SWANBR_COPYRIGHT_$" . g:pdv_cfg_EOL
    exe l:txtBOL . l:txtHR_C . g:pdv_cfg_EOL
    exe l:txtBOL . "// | Version  $_SWANBR_VERSION_$" . g:pdv_cfg_EOL
    exe l:txtBOL . l:txtHR_C . g:pdv_cfg_EOL
    exe l:txtBOL . "// | Licensed ( $_SWANBR_LICENSED_URL_$ )" . g:pdv_cfg_EOL
    exe l:txtBOL . l:txtHR_C . g:pdv_cfg_EOL
    exe l:txtBOL . "// | $_SWANBR_WEB_DOMAIN_$" . g:pdv_cfg_EOL
    exe l:txtBOL . l:txtHR_C . g:pdv_cfg_EOL
    exe l:txtBOL . " " . g:pdv_cfg_EOL
    
    exe l:txtBOL . g:pdv_cfg_CommentHead . g:pdv_cfg_EOL
    exe l:txtBOL . l:txtHR_B . g:pdv_cfg_EOL
	exe l:txtBOL . g:pdv_cfg_Comment_not_space . l:classname . " " . g:pdv_cfg_EOL
    exe l:txtBOL . l:txtHR_B . g:pdv_cfg_EOL
    exe l:txtBOL . g:pdv_cfg_Comment_not_space . g:pdv_cfg_EOL
    if l:extends != "" && l:extends != "implements"
    	exe l:txtBOL . g:pdv_cfg_Comment_not_space . "@uses " . l:extends . g:pdv_cfg_EOL
    endif
	...
	while (l:interfaces != ",") && (l:interfaces != "")
		...
		exe l:txtBOL . g:pdv_cfg_Comment_not_space . "@uses " . l:interface . g:pdv_cfg_EOL
	endwhile

	if l:abstract != ""
        exe l:txtBOL . g:pdv_cfg_Comment_not_space . "@abstract" . g:pdv_cfg_EOL
    endif
	if l:final != ""
        exe l:txtBOL . g:pdv_cfg_Comment_not_space . "@final" . g:pdv_cfg_EOL
    endif
	exe l:txtBOL . g:pdv_cfg_Comment_not_space . "@package " . g:pdv_cfg_Package . g:pdv_cfg_EOL
	exe l:txtBOL . g:pdv_cfg_Comment_not_space . "@version " . g:pdv_cfg_Version . g:pdv_cfg_EOL
	exe l:txtBOL . g:pdv_cfg_Comment_not_space . "@copyright " . g:pdv_cfg_Copyright . g:pdv_cfg_EOL
	exe l:txtBOL . g:pdv_cfg_Comment_not_space . "@author " . g:pdv_cfg_Author g:pdv_cfg_EOL
